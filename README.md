...
> **Project status: GA (`1.0.3`).** Supported platforms, versioning, runbooks, and release artifacts are documented. See `docs/SUPPORT_POLICY.md` and `docs/GA_CHECKLIST.md`.

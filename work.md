...
- **Sprint 8 (`0.9.0-beta.1`)** — feature freeze, compat matrix, upgrade rehearsal, beta RC docs/version.

## Current sprint: Sprint 9 → `1.0.0`

GA: security/perf/support-policy sign-off, then tag `1.0.0`.
